...
%token ASIN ACOS ATAN SIN SINH COS COSH TAN TANH INC DEC LAND OR  XOR ASSIGN IOR AND  CEIL FLOOR ABS FACTORIAL BIN_DEC CUBEROOT
...
function: SIN OPENBRACKET expr CLOSEBRACKET
	...
	| BIN_DEC OPENBRACKET expr CLOSEBRACKET
		{ $$ = bin_dec((float)$3);}
	| CUBEROOT OPENBRACKET expr CLOSEBRACKET
		{ $$ = cbrt((float)$3);}
	| NUMBER
        ;
%%
